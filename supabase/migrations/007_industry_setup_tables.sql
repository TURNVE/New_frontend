-- Migration: Industry/company setup persistence
-- Creates the missing tables used by organization signup, company dashboards,
-- and custom industry simulation setup flows. Idempotent for partially applied projects.
...
create index if not exists idx_company_simulations_owner
  on public.company_simulations(owner_id);
create index if not exists idx_company_simulations_public
  on public.company_simulations(is_public, status);
create index if not exists idx_company_simulations_updated
  on public.company_simulations(updated_at desc);
...
grant select on public.company_simulations to anon;
grant select on public.organizations to anon;
grant select on public.organization_simulations to anon;
grant select on public.organization_clients to anon;
grant select on public.organization_access_links to anon;
grant select, insert, update, delete on public.company_simulations to authenticated;
grant select, insert, update, delete on public.organizations to authenticated;
grant select, insert, update, delete on public.organization_members to authenticated;
grant select, insert, update, delete on public.organization_simulations to authenticated;
grant select, insert, update, delete on public.organization_clients to authenticated;
grant select, insert, update, delete on public.client_simulations to authenticated;
grant select, insert, update, delete on public.organization_access_links to authenticated;
grant select, insert on public.organization_activity to authenticated;
