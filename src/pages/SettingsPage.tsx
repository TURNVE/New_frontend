      ...
      <header className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <Link to="/dashboard" className="text-sm font-medium text-muted-foreground hover:text-foreground flex items-center gap-1">
              ...
              <div className="bg-card rounded-2xl border border-border shadow-sm">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <button className="px-4 py-2 bg-blue-50 dark:bg-blue-950 text-blue-600 dark:text-blue-400 rounded-xl text-sm font-medium hover:bg-blue-100 dark:hover:bg-blue-900 transition-colors flex items-center gap-2 whitespace-nowrap">
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950 rounded-xl flex items-center justify-center">
                    ...
                    <div className="p-4 bg-secondary rounded-xl">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 bg-violet-50 dark:bg-violet-950 rounded-xl flex items-center justify-center">
                  ...
                  <div className="p-6">
                    ...
                    <div className="p-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl text-white mb-6">
                      <div className="flex items-center justify-between">
                        ...
                        <button className="px-5 py-2.5 bg-card text-primary rounded-xl font-semibold hover:bg-blue-50 dark:hover:bg-blue-950 transition-colors whitespace-nowrap">
                          Upgrade to Pro
                        </button>
                      </div>
                    </div>
