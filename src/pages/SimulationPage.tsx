          ...
          <header className="h-16 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-8 bg-white/50 dark:bg-gray-900/50 backdrop-blur-md z-10">
            ...
            <div className="flex items-center gap-2">
              ...
              {!isRunning ? (
                ...
                <button onClick={pauseSimulation} className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 px-4 py-2 rounded-md text-sm font-semibold transition-all flex items-center gap-2 relative overflow-hidden group">
                            ...
                            <div key={person.id} className="flex items-center gap-3">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="h-1 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                                  <div className={`h-full transition-all duration-500 ${person.satisfaction > 70 ? 'bg-emerald-500' : person.satisfaction > 40 ? 'bg-amber-500' : 'bg-red-500'}`} style={{ width: `${person.satisfaction}%` }} />
                                </div>
                              </div>
                            </div>
                          ))}
